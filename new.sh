...
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB SHARK    "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB XXX     "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB RENZZZA2        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE HNXIzqou       "$i"|"$i"    |"$cy" K"$i" |"
