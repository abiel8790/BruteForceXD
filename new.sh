...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Abiel DXD  [SHARKX2]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Abiel Adhafit"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [google.com] [otak] [Tuhan yme]"$i"  |"
echo $i" |"$cy"            ~ [XXX] [RexDroo] [RENZZZA2]"$i" |"
echo $i" |"$pu" FOR :"$ku" ALL"$i"             |"
echo $i" |"$pu" Contact Gmail :"$ku" abieladhafit@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB SHARK      "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB XXX        "$i"|"$i"    |"$cy" I"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB RENZZZA2   "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE HNXIzqou       "$i"|"$i"    |"$cy" L"$i" |"
echo $i"|"$me" 6"$i" |"$cy" BRUTEFORCE FB ( root )   "$i"|"$i"    |"$cy" #"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
echo $i"|"$me" 7"$i" |"$cy" YAHOO CLONING FACEBOOK   "$i"|"$i"    ─────"
echo $i"|"$me" 8"$i" |"$cy" PROFILE GUARD FACEBOOK   "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 9"$i" |"$cy" REPORT FACEBOOK WORK     "$i"|"$i"    |"$cy" D"$i" |"
echo $i"|"$me"10"$i" |"$cy" AUTO REACTION FACEBOOK   "$i"|"$i"    |"$cy" H"$i" |"
echo $i"|"$me"11"$i" |"$cy" INFORMATION FACEBOOK     "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me"12"$i" |"$cy" BOT KOMEN FACEBOOK       "$i"|"$i"    |"$cy" F"$i" |"
echo $i"|"$me"13"$i" |"$cy" AUTOLIKE FACEBOOK        "$i"|"$i"    |"$cy" I"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" O"$i" |"
echo $i"|"$me"14"$i" |"$cy" PHISING FACEBOOK 1       "$i"|"$i"    |"$cy" T"$i" |"
...
echo $i"────────────────────────────────"$i"                      |"$cy" D"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN            "$i"|"$i"    |"$cy" x"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" D"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"ABIEL DXD"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Facebook :"$i" Abiel Adhafit"
sleep 2
